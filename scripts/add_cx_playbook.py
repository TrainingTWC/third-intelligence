...
new_modules = [
    # ── MODULE 1: BLEND Framework Overview ──
    {
        ...
        "description": "The BLEND framework defines the five pillars of in-store customer experience execution at Third Wave Coffee / Third Rush: Brand Touchpoints, Learning & Leadership, Engage & Elevate, Notice & Nurture, and Driven by R.E.S.P.E.C.T.",
        "chunks": [
            {
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "What are the five pillars of CX execution at Third Wave Coffee?", "output": "The five pillars are: Brand Touchpoints, Learning & Leadership, Engage & Elevate, Notice & Nurture, and Driven by R.E.S.P.E.C.T. — collectively known as the BLEND framework."},
                    {"instruction": "What is the CX in-store execution framework?", "output": "It's called BLEND. It ensures consistent customer experience across all Third Wave Coffee / Third Rush stores through five pillars: Brand Touchpoints, Learning & Leadership, Engage & Elevate, Notice & Nurture, and Driven by R.E.S.P.E.C.T."}
                ]
            },
            {
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "What are brand touchpoints at Third Wave Coffee?", "output": "Brand touchpoints are the six Gold Standard interactions: Cheerful Greeting (2M Rule), Order Taking Assistance, Friendly & Accurate Service, Feedback With Solutions, Enjoyable Experience, and Enthusiastic Exit (2M Rule)."},
                    {"instruction": "How should a barista greet customers at Third Wave Coffee?", "output": "Smile, make eye contact, and greet in a gentle audible tone: 'Hi, welcome to Third Wave Coffee / Third Rush.' If the customer is farther away, acknowledge with eye contact and a smile. Go beyond by helping them find a table, assisting with queries, and greeting children warmly. Avoid loud greetings to not disturb other customers."},
            ...
            },
            {
                ...
                "intent": "Describe the training levels and learning resources for CX at Third Wave Coffee.",
    ...
    # ── MODULE 2: C.O.F.F.E.E. Framework ──
    {
        ...
        "description": "The C.O.F.F.E.E. framework defines the six steps of customer experience at Third Wave Coffee: Cheerful Welcome, Order Taking Assistance, Friendly & Accurate Service, Feedback With Solutions, Enjoyable Experience, and Enthusiastic Exit.",
        "chunks": [
            {
            ...
            },
            {
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "What is smart selling at Third Wave Coffee?", "output": "Smart selling means accommodating special requests or dietary needs while suggesting complementary items — like desserts with coffee — to enhance the guest experience without pushing extra products."}
                ]
            },
            {
            ...
            },
            {
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "What does C.O.F.F.E.E. stand for?", "output": "C.O.F.F.E.E. stands for: Cheerful Welcome, Order Taking Assistance, Friendly & Accurate Service, Feedback With Solutions, Enjoyable Experience, and Enthusiastic Exit. These are the six steps of the customer experience framework at Third Wave Coffee."}
                ]
            }
        ]
    },
        ...
        "chunks": [
            {
                ...
                "content": "Scenario scripts for cheerful welcome. Family with small kid, senior citizens, and a young lady: Greet the kids first then the rest. Bend/kneel to talk to kids, stand and maintain eye contact with rest. Friendly and excited tone. Script: 'Hello (to the kids)! Good morning/evening. Welcome to Third Wave Coffee/Third Rush. Hello everyone!' Group of teenagers: Open the door if nearby. Wave and maintain eye contact. Script: 'Hi! Good morning/evening, welcome to Third Wave Coffee / Third Rush.' Lady with multiple shopping bags: Open the door and offer help with bags. Hold the door and gesture toward bags. Script: 'Hi Ma'am, welcome to Third Wave Coffee / Third Rush. May I carry those bags or help you find a table?' Physically handicapped customer: Open the door and offer assistance. Reach for the door quickly. Script: 'Hello Ma'am/Sir, welcome to Third Wave Coffee / Third Rush. Please allow me to assist you.' Regular customer: Open the door if possible. Wave with a smile. Script: 'Hello Ma'am/Sir, welcome to Third Wave Coffee / Third Rush. Good to see you again!' New customer: Acknowledge and guide inside. Smile, maintain eye contact, gesture toward counter or seating. Script: 'Good morning/evening Ma'am/Sir, welcome to Third Wave Coffee / Third Rush.' Customer with baby and handbag: Open the door and offer help with bags. Reach the door quickly and gesture toward the bags. Script: 'Hi Ma'am/Sir, welcome to Third Wave Coffee / Third Rush. Please allow me to assist you with the bags.' Customer talking on phone: Acknowledge without interrupting. Smile and nod, gesture toward seating. Script: 'Welcome to Third Wave Coffee / Third Rush.' Confused customer looking for something: Approach and offer help. Maintain eye contact and gesture toward counter/menu. Script: 'Hello Ma'am/Sir, welcome to Third Wave Coffee / Third Rush. May I help you?' Customer during busy rush: Acknowledge immediately. Make quick eye contact and smile. Script: 'Hi! Welcome to Third Wave Coffee / Third Rush. We will be right with you.'",
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "How do I greet a physically handicapped customer?", "output": "Open the door and offer assistance. Reach for the door quickly. Use a friendly and empathetic tone: 'Hello Ma'am/Sir, welcome to Third Wave Coffee / Third Rush. Please allow me to assist you.'"},
                    {"instruction": "What should I say to a regular customer entering the café?", "output": "Open the door if possible, wave with a smile, and say: 'Hello Ma'am/Sir, welcome to Third Wave Coffee / Third Rush. Good to see you again!'"},
                    {"instruction": "How should I handle greeting during a busy rush?", "output": "Acknowledge immediately with quick eye contact and a smile. Say: 'Hi! Welcome to Third Wave Coffee / Third Rush. We will be right with you.'"},
                    {"instruction": "What if a customer is on the phone when entering?", "output": "Acknowledge without interrupting. Smile and nod, gesture toward seating. Simply say: 'Welcome to Third Wave Coffee / Third Rush.'"},
                    {"instruction": "How do I greet a customer carrying shopping bags?", "output": "Open the door and offer help with bags. Hold the door and gesture toward the bags. Say: 'Hi Ma'am, welcome to Third Wave Coffee / Third Rush. May I carry those bags or help you find a table?'"}
                ]
            },
            {
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "What payment options are available at Third Wave Coffee?", "output": "Third Wave Coffee accepts cash, card, UPI, wallet and wave coins. Say: 'Absolutely ma'am/sir, we accept cash, card, UPI, wallet and wave coins.'"},
            ...
            },
            {
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "Can we change the music genre for a customer?", "output": "No, the playlist is centrally managed. Politely explain: 'I'm sorry Ma'am/Sir, the playlist is centrally managed at Third Wave Coffee / Third Rush, so we're unable to change it.'"},
                    ...
                    {"instruction": "Are pets allowed inside Third Wave Coffee?", "output": "No, pets aren't allowed inside. Politely suggest outdoor seating: 'I'm sorry Ma'am/Sir, pets aren't allowed inside. You're welcome to sit in the outdoor seating area.'"},
        ...
        "chunks": [
            ...
            },
            {
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "What are the loyalty tiers on the Third Wave Coffee app?", "output": "Three tiers: Partner (default — Rs 100 OFF + 1 Free Coffee), Influencer (6 orders — 10% Wave Coins + 2 Free Coffees), Ambassador (12 orders — 15% Wave Coins). Maintain order counts within 90-day cycles to keep your tier."},
                    ...
                    {"instruction": "What are Wave Coins?", "output": "Wave Coins are loyalty rewards in the Third Wave Coffee App. Influencer tier members earn 10% Wave Coins and Ambassador tier members earn 15% Wave Coins. They can be used for payment (online only)."}
                ]
            },
            {
                ...
                "qa_pairs": [
                    ...
                    {"instruction": "What does consistency mean in CX at Third Wave Coffee?", "output": "Consistency means same taste, same quality, every time. It includes SOP adherence, maintaining cleanliness and ambiance daily, and reliable service standards. Consistency builds customer trust."},
            ...
            },
            {
                ...
                "qa_pairs": [
                    {"instruction": "Why are coffee tastings important at Third Wave Coffee?", "output": "Coffee tastings showcase barista knowledge and craft, build customer trust by showing confidence in product quality, and boost sales by reducing hesitation about new items. They create memorable experiences and build long-term customer loyalty."},
